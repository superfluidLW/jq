...
//        String[][] trade = XlFunc.transpose(DoubleBarrierOption.templateTradeData());
//
...
//
//        System.out.println(JsonUtils.writeValueAsString(result));
//        assert Math.abs(result.getPv() - 0.010845) < 1.0e-6;
//        assert Math.abs(result.getDelta() - 0.005738) < 1e-6;
//        assert Math.abs(result.getGamma() - (-0.487205)) < 1.0e-6;
//        assert Math.abs(result.getRho() - 0.00000241) < 1.0e-5;
//        assert Math.abs(result.getVega() - (-0.001063)) < 1.0e-6;
//        assert Math.abs(result.getTheta() - (0.000027)) < 1.0e-6;
//    }
//
//    @Test
...
//
//        System.out.println(JsonUtils.writeValueAsString(result));
//        assert Math.abs(result.getPv() - 0.049021) < 1.0e-6;
//        assert Math.abs(result.getDelta() - (-0.136558)) < 1e-6;
//        assert Math.abs(result.getGamma() - (-1.397878)) < 1.0e-6;
//        assert Math.abs(result.getRho() - (-0.0000215)) < 1.0e-6;
//        assert Math.abs(result.getVega() - (-0.002692)) < 1.0e-6;
//        assert Math.abs(result.getTheta() - (0.000092)) < 1.0e-6;
//    }
//
//
//    @Test
...
//
//        System.out.println(JsonUtils.writeValueAsString(result));
//        assert Math.abs(result.getPv() - 0.049021) < 1e-3;
//    }
//
//
//    @Test
...
//
//        System.out.println(JsonUtils.writeValueAsString(result));
//        assert Math.abs(result.getPv() - 0.010845) < 1.0e-3;
//    }
//
//    @Test

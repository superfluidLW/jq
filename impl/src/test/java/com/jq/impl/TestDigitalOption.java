...
public class TestDigitalOption {
    ...
    public void printTemplate(){
        Security security = new Security("SH000300", Venue.ShExg);
...
//        assert Math.abs(result.getPv() - 0.531954) < 1.0e-6;
//        assert Math.abs(result.getDelta() - 0.018397) < 2.0e-6;
//        assert Math.abs(result.getGamma() - (-0.000315)) < 1.0e-6;
//        assert Math.abs(result.getRho() - 0.00013439) < 1.0e-5;
//        assert Math.abs(result.getVega() - (-0.006560)) < 1.0e-6;
//        assert Math.abs(result.getTheta() - (0.0000981)) < 1.0e-6;
    }
...
//        Result result = XlFunc.jqCalc(XlFunc.transpose(table), mktData);
//        assert Math.abs(result.getPv() - 0.419275) < 1.0e-6;
//        assert Math.abs(result.getDelta() - (-0.018397)) < 2.0e-6;
//        assert Math.abs(result.getGamma() - 0.000315) < 1.0e-6;
//        assert Math.abs(result.getRho() - (-0.00022952)) < 1.0e-6;
//        assert Math.abs(result.getVega() - 0.006560) < 1.0e-6;
//        assert Math.abs(result.getTheta() - (0.000032)) < 1.0e-6;
    }
...
//        Result result = XlFunc.jqCalc(XlFunc.transpose(table), mktData);
//        System.out.println(JsonUtils.writeValueAsString(result));
//        assert Math.abs(result.getPv() - 0.531954) < 0.01;
    }

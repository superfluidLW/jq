...
public class JqProp {
    public static String[][] GetAllProps(){
        List<Class> enumClz = Arrays.asList(BizDayAdjust.class, Currency.class, DayCountType.class, Frequency.class, OptionDirection.class, Stub.class, TradeLabel.class, TradeType.class, ValuationModel.class, Venue.class, MktDataType.class);
